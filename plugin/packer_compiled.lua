...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'playground', 'vim-surround', 'tabout.nvim', 'emmet-vim', 'nvim-ts-context-commentstring', 'vim-graphql', 'undotree', 'nvim-colorizer.lua', 'gitsigns.nvim', 'refactoring.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
