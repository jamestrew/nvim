...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp_signature.nvim', 'nvim-treesitter', 'indent-blankline.nvim', 'tabout.nvim', 'emmet-vim', 'nvim-ts-context-commentstring', 'undotree', 'playground', 'nvim-lsp-ts-utils', 'treesitter-unit', 'nvim-colorizer.lua', 'gitsigns.nvim', 'vim-graphql', 'vim-surround', 'refactoring.nvim', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
