...
Group.new("DiagnosticHint", colors.base0C, colors.none, none)
...
Group.new("DiagnosticVirtualTextInfo", colors.green, colors.none, none)
...
Group.new("DiagnosticUnderlineInfo", colors.green, colors.none, underline)
...
Group.new("DiagnosticFloatingInfo", colors.green, groups.pmenu, underline)
...
Group.new("DiagnosticSignInfo", colors.green, colors.none, none)
