...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-ts-utils', 'emmet-vim', 'playground', 'undotree', 'nvim-ts-context-commentstring'}, { event = "BufRead *" }, _G.packer_plugins)]]
