...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'undotree', 'vim-repeat', 'nvim-lsp-ts-utils', 'playground', 'nvim-ts-context-commentstring', 'emmet-vim', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
