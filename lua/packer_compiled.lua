...
local no_errors, error_msg = pcall(function()
  ...
  vim.cmd([[au BufRead * ++once lua require("packer.load")({'emmet-vim', 'playground', 'nvim-lsp-ts-utils', 'undotree', 'nvim-ts-context-commentstring', 'vim-surround', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]])
