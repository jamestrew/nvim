...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'treesitter-unit', 'undotree', 'vim-graphql', 'nvim-treesitter-context', 'nvim-ts-context-commentstring', 'vim-repeat', 'vim-surround', 'playground', 'refactoring.nvim', 'nvim-colorizer.lua', 'emmet-vim', 'tabout.nvim', 'nvim-lsp-ts-utils'}, { event = "BufRead *" }, _G.packer_plugins)]]
