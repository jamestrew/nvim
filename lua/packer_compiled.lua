...
local no_errors, error_msg = pcall(function()
  ...
  _G.packer_plugins = {
    ...
    ["spellsitter.nvim"] = {
      loaded = true,
      path = "/home/jt/.local/share/nvim/site/pack/packer/start/spellsitter.nvim",
  ...
  vim.cmd([[au BufRead * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'nvim-lsp-ts-utils', 'playground', 'vim-repeat', 'undotree', 'vim-surround', 'emmet-vim'}, { event = "BufRead *" }, _G.packer_plugins)]])
