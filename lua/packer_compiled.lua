...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'emmet-vim', 'nvim-lsp-ts-utils', 'nvim-ts-context-commentstring', 'playground', 'vim-repeat', 'undotree'}, { event = "BufRead *" }, _G.packer_plugins)]]
