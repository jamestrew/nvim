...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'playground', 'undotree', 'nvim-lsp-ts-utils', 'emmet-vim', 'nvim-ts-context-commentstring'}, { event = "BufRead *" }, _G.packer_plugins)]]
