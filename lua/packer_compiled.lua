...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'playground', 'nvim-ts-context-commentstring', 'nvim-lsp-ts-utils', 'vim-repeat', 'emmet-vim', 'undotree'}, { event = "BufRead *" }, _G.packer_plugins)]]
