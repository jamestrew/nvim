...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-ts-utils', 'nvim-ts-context-commentstring', 'undotree', 'emmet-vim', 'playground'}, { event = "BufRead *" }, _G.packer_plugins)]]
