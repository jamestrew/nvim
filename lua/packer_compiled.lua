...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'emmet-vim', 'undotree', 'playground', 'nvim-ts-context-commentstring', 'vim-surround', 'nvim-lsp-ts-utils', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
