...
local no_errors, error_msg = pcall(function()
  ...
  vim.cmd([[au BufRead * ++once lua require("packer.load")({'nvim-lsp-ts-utils', 'vim-repeat', 'vim-surround', 'emmet-vim', 'nvim-ts-context-commentstring', 'treesitter-unit', 'playground', 'vim-graphql', 'refactoring.nvim', 'undotree', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]])
