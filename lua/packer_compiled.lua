...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'emmet-vim', 'playground', 'nvim-ts-context-commentstring', 'undotree', 'nvim-lsp-ts-utils'}, { event = "BufRead *" }, _G.packer_plugins)]]
