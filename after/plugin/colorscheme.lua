...
Group.new("TelescopeTitle", colors.base08, colors.none, none)
Group.new("TelescopePromptTitle", colors.base08, colors.none, none)
Group.new("TelescopeResultsTitle", colors.base08, colors.none, none)
Group.new("TelescopePreviewTitle", colors.base08, colors.none, none)
