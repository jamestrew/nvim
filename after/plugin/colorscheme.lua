...
Group.new("TSText", colors.base05, colors.none, styles.NONE)
Group.new("TSStrong", colors.base07, colors.none, styles.bold)
Group.new("TSEmphasis", colors.base06, colors.none, styles.italic)
Group.new("TSUnderline", colors.base05, colors.none, styles.underline)
