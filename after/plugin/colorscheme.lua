...
-- treesitter
Group.new("TSNone", colors.base05, colors.none, styles.NONE)
Group.new("TSPunctDelimiter", colors.base08, colors.none, styles.NONE)
Group.new("TSPunctBracket", colors.base08, colors.none, styles.NONE)
Group.new("TSPunctSpecial", colors.base0F, colors.none, styles.NONE)
Group.new("TSConstant", colors.base09, colors.none, styles.bold)
Group.new("TSConstBuiltin", colors.base0C, colors.none, styles.NONE)
Group.new("TSConstMacro", colors.base0E, colors.none, styles.NONE)
Group.new("TSString", colors.base0B, colors.none, styles.NONE)
Group.new("TSStringRegex", colors.base0B, colors.none, styles.NONE)
Group.new("TSStringEscape", colors.base0F, colors.none, styles.NONE)
Group.new("TSCharacter", colors.base08, colors.none, styles.NONE)
Group.new("TSNumber", colors.base09, colors.none, styles.NONE)
Group.new("TSBoolean", colors.base0B, colors.none, styles.bold)
Group.new("TSFloat", colors.base0B, colors.none, styles.NONE)
Group.new("TSFunction", colors.base0D, colors.none, styles.bold)
Group.new("TSFuncBuiltin", colors.base0C, colors.none, styles.NONE)
Group.new("TSFuncMacro", colors.base08, colors.none, styles.NONE)
Group.new("TSParameter", colors.base08, colors.none, styles.NONE)
Group.new("TSParameterReference", colors.base08, colors.none, styles.NONE)
Group.new("TSMethod", colors.base0D, colors.none, styles.bold)
Group.new("TSField", colors.base0A, colors.none, styles.NONE)
Group.new("TSProperty", colors.base08, colors.none, styles.NONE)
Group.new("TSConstructor", colors.base0C, colors.none, styles.NONE)
Group.new("TSAnnotation", colors.base0A, colors.none, styles.NONE)
Group.new("TSAttribute", colors.base0A, colors.none, styles.NONE)
Group.new("TSNamespace", colors.base0D, colors.none, styles.NONE)
Group.new("TSConditional", colors.base0E, colors.none, styles.NONE)
Group.new("TSRepeat", colors.base0D, colors.none, styles.NONE)
Group.new("TSLabel", colors.base0A, colors.none, styles.NONE)
Group.new("TSOperator", colors.base07, colors.none, styles.NONE)
Group.new("TSKeyword", colors.base0E, colors.none, styles.NONE)
Group.new("TSKeywordFunction", colors.base0E, colors.none, styles.bold)
Group.new("TSKeywordOperator", colors.base08, colors.none, styles.NONE)
Group.new("TSException", colors.base08, colors.none, styles.NONE)
Group.new("TSType", colors.base0A, colors.none, styles.bold)
Group.new("TSTypeBuiltin", colors.base0A, colors.none, styles.bold)
Group.new("TSInclude", colors.base0D, colors.none, styles.NONE)
Group.new("TSVariableBuiltin", colors.base0C, colors.none, styles.NONE)
Group.new("TSText", colors.base05, colors.base00, styles.NONE)
Group.new("TSStrong", colors.base07, colors.base00, styles.bold)
Group.new("TSEmphasis", colors.base06, colors.base00, styles.italic)
Group.new("TSUnderline", colors.base05, colors.base00, styles.underline)
Group.new("TSTitle", colors.base0D, colors.none, styles.NONE)
Group.new("TSLiteral", colors.base0B, colors.none, styles.NONE)
Group.new("TSURI", colors.base08, colors.none, styles.NONE)
Group.new("TSTag", colors.base0A, colors.none, styles.NONE)
Group.new("TSTagDelimiter", colors.base0F, colors.none, styles.NONE)
Group.new("TSDefinitionUsage", colors.none, colors.base02, styles.NONE)
Group.new("TSDefinition", colors.base01, colors.base0A, styles.NONE)
Group.new("TSCurrentScope", colors.none, colors.base01, styles.NONE)
...
-- telescope
Group.new("TelescopeBorder", colors.lightbg, colors.none, styles.NONE)
Group.new("TelescopePromptBorder", colors.lightbg, colors.none, styles.NONE)
Group.new("TelescopeResultsBorder", colors.lightbg, colors.none, styles.NONE)
Group.new("TelescopePreviewBorder", colors.lightbg, colors.none, styles.NONE)
...
Group.new("TelescopePromptTitle", colors.base08, colors.none, styles.NONE)
Group.new("TelescopeResultsTitle", colors.base08, colors.none, styles.NONE)
Group.new("TelescopePreviewTitle", colors.base08, colors.none, styles.NONE)
...
Group.new("MoreMsg", colors.base0B, colors.none, styles.NONE)
Group.new("Question", colors.base0D, colors.none, styles.NONE)
Group.new("Search", colors.base0A, colors.none, styles.undercurl)
Group.new("Substitute", colors.base0A, colors.none, styles.undercurl)
Group.new("SpecialKey", colors.base03, colors.none, styles.NONE)
Group.new("TooLong", colors.base08, colors.none, styles.NONE)
Group.new("Underlined", colors.base08, colors.none, styles.NONE)
Group.new("Visual", colors.none, colors.base02, styles.NONE)
